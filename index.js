...
app.get('/', function (req, res) {
    ...
    // ISS (Zaraya)
    var issLine1 = "1 25544U 98067A   17335.37265353  .00036663  00000-0  55958-3 0  9992";
    var issLine2 = "2 25544  51.6427 284.8750 0003522 180.2908 324.4182 15.54072402 87752";
    ...
    var observerPos = {
        latitude: 35.3008717 * SGP4.deg2rad,
        longitude: -120.6600305 * SGP4.deg2rad,
        height: 1
    };
    ...
    var az = lookAngles.azimuth * SGP4.rad2deg,
        el = lookAngles.elevation * SGP4.rad2deg;

    console.log("Azimuth: " + az);
    console.log("Elevation: " + el);

    res.send({"elevation": el, "azimuth": az});
});
...
/*
 * https://github.com/joshuaferrara/node-sgp4
 */
